...
import { PJU_WIKI_ARTICLES } from '../content/wiki/pju';
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              <h1 className="text-h4 font-bold text-gray-900">Wiki do Usuario (PJU)</h1>
              <p className="text-body text-gray-500">
                Acesso administrativo para revisar e abrir as paginas publicas da wiki.
              </p>
            </div>
            <Link
              to="/admin"
              ...
              <div key={href} className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="text-body-xs text-gray-500 mt-2">Atualizado em: {article.updatedAt}</p>
                  </div>
