...
const evaluateExpression = (expression: string): number | null => {
    ...
    try {
        // Expression is restricted to numbers and basic operators.
    ...
    return (
        <>
            <button
                ...
                className="fixed bottom-24 right-4 z-40 rounded-full bg-secondary px-4 py-2 text-body-xs font-bold text-white shadow-lg hover:bg-secondary-700 lg:bottom-8"
            >
                Calculadora
            </button>
            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/45 p-4">
                    <div className="w-full max-w-sm rounded-2xl bg-white p-4 shadow-2xl dark:bg-neutral-900">
